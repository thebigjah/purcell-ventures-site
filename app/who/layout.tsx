...
const QA: [string, string][] = [
  ...
  ["Which Elijah Purcell is this? There seem to be several.",
   "There are several. This one is the founder of Purcell Ventures LLC and a psychology and data science student at the University of Alabama in Tuscaloosa. He is not the campus pastor at Liberty Church in Pensacola, Florida, not the Farragut High School football recruit in Knoxville, Tennessee, not the amateur boxer in Brisbane, Australia, and not the linebacker at the University of Tennessee. Those are four different people who share the name."],
